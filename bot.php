...
foreach ($client->parseEvents() as $event) {
    switch ($event['type']) {
        case 'message':
            ...
            $json = file_get_contents('https://docs.google.com/spreadsheets/d/e/2PACX-1vQWt5TwDvY4KI6H5osHItiRDhiNaAXyyW0sOAofyeJ49vkV3XxKWgR0qJTSnSojrkokCamQHhbHc_mn/pubhtml?gid=0&single=true');
